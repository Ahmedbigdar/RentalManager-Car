...
const NouvelleVoitures = () => {
  ...
  const validateFields = () => {
    ...
    if(Car.anneedimmatricule > new Date().getFullYear()|| Car.anneedimmatricule < 1 || Car.anneedimmatricule === ""){
      errors.anneedimmatricule = `l'année doit étre <= ${new Date().getFullYear()}`
    }
    return errors;
  };
      ...
      <form onSubmit={handleSubmitData}>
        ...
        <div className="immatricule d-flex">
          ...
          <div className="mb-3" style={{ marginLeft: "10px" }}>
            ...
            />
            {validationErrors.anneedimmatricule && (
              <div className="text-danger">{validationErrors.anneedimmatricule}</div>
            )}
          </div>
        </div>
...
export default NouvelleVoitures;
